About typogrify-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/typogrify-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5118&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/typogrify-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `typogrify` can be installed with `conda`:
...
```
mamba install typogrify
```

It is possible to list all of the versions of `typogrify` available on your platform with `conda`:
...
```
mamba search typogrify --channel conda-forge
```
...
mamba repoquery search typogrify --channel conda-forge

# List packages depending on `typogrify`:
mamba repoquery whoneeds typogrify --channel conda-forge

# List dependencies of `typogrify`:
mamba repoquery depends typogrify --channel conda-forge
```
